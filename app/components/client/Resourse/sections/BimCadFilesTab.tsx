...
const ResourceDownloadCard = ({ item }: { item: BimCadFilesItem }) => {
  ...
  return (
     <article className="h-[116px] md:h-auto  bg-[#F4F4F4] px-2.5 md:px-25 md:px-40 py-[15px] md:py-6 md:py-35 grid grid-cols-[50px_1fr] items-center  sm:grid-cols-[78px_1fr] lg:grid-cols-[101px_1fr] gap-[14px] md:gap-5 xl:gap-10 ">
