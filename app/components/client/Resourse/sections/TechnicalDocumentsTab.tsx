...
const TechnicalDocumentsTab = ({ tab }: TechnicalDocumentsTabProps) => {
  ...
  return (
    <div className="pt-[30px] md:pt-70 md:pt-100">
      <h2 className="text-[24px] md:text-55 leading-[1.34] md:leading-[1.1] font-light text-secondary max-w-[30ch] mb-5">
        {tab.title}
      </h2>
...
const ResourceDownloadCard = ({ item }: { item: TechnicalDocumentItem }) => {
  ...
  return (
    <article className="bg-[#F4F4F4] px-2.5 md:px-25 md:px-40 py-[15px] md:py-6 md:py-35 grid grid-cols-[50px_1fr] items-center  sm:grid-cols-[78px_1fr] gap-[14px] md:gap-5 xl:gap-10 ">
      <div className={`w-12.5 sm:w-[78px] h-12.5 sm:h-[78px] flex items-center justify-center text-24 font-poppins font-[600] 
      ...
      <div className="flex min-w-0 flex-col gap-y-[5px] md:gap-y-2 xl:gap-y-[15px]">
        <h3 className="text-[18px] md:text-30 leading-[1.56] tracking-[-2%] md:tracking-normal md:leading-[1.333333333333333] font-poppins font-light text-secondary">{item.title}</h3>
        <p className="text-[12px] md:text-19 leading-[1.67] md:leading-[1.526315789473684] font-poppins font-light text-paragraph">{item.desc}</p>
        <div className="mt-[6px] md:mt-auto flex flex-wrap items-center justify-between gap-2 lg:gap-20">
          ...
          <a href={item.download} className="group inline-flex items-center gap-2.5 md:gap-3 text-[12px] md:text-[15px] leading-none font-poppins font-light uppercase text-primary" >
            <span className="uppercase font-normal md:font-[300]">Download</span>
