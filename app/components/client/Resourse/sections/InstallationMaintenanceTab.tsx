...
const ResourceDownloadCard = ({ item, delay }: { item: InstallationMaintenanceItem, delay: number }) => {
  ...
  return (
    <motion.article
      ...
      <div className="flex flex-col min-w-0 w-full justify-between gap-y-[5px] md:gap-y-2 xl:gap-y-[15px]">
        <div>
          <h3 className="text-[18px] md:text-30 leading-[1.56] tracking-[-2%] md:leading-[1.333333333333333] font-poppins font-light text-secondary mb-0 md:mb-[15px] line-clamp-2">
            {item.title}
          </h3>
        </div>
