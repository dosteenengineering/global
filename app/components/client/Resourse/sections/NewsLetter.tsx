...
const NewsLetter = ({data}: Props) => {
  return ( 
    <section className="relative py-120 md:py-140 xl:py-150 overflow-hidden">
      <SecondaryNoise/>
      <div className="container relative z-2">
        ...
        <form className="flex w-full max-w-[478px] items-center overflow-hidden rounded-full border border-black/80">
          <input type="email" aria-label="Email address" placeholder="Enter Your Email"
            className="min-w-0 flex-1 bg-transparent px-6 md:py-4 text-16 text-black outline-none placeholder:text-black/55 md:px-25"
          />
          <BorderButton
            text="Subscribe"
            type="submit"
