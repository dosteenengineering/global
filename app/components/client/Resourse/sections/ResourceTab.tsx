    ...
    <section className="pt-[70px] md:pt-120 pb-200 overflow-hidden">
      <div className="container">
        ...
        <div ref={dropdownRef} className="relative md:hidden mb-50">
          ...
          <svg width="17" height="9" viewBox="0 0 17 9" fill="none" xmlns="http://www.w3.org/2000/svg" className={`transition-transform duration-300 ${
                isDropdownOpen ? "rotate-180" : "rotate-0"
              }`}>
          <path d="M15.9858 0.5L8.22743 8.10624L0.5 0.525901" stroke="#161616" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
      ...
      {data.tabs.map((tab, index) => {
        ...
        return (
          ...
          >
            ...
            />
            <span
              className={`text-19 leading-[1.526315789473684] text-secondary font-poppins transition-all duration-300 ${
