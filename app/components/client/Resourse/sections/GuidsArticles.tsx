...
const GuidesArticles = ({ data }: GuidesArticlesProps) => {
  return (
    <section className="relative overflow-hidden py-120 md:py-140 2xl:py-150">
      <PrimaryNoise2 />
      <div className="container">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 3xl:grid-cols-[705.74px_566.99px_auto] text-white relative z-2 gap-y-5 items-end">
          {data.items.map((item, index) => (
            <div key={item.id} className="border-b pb-4 xl:pb-0 xl:border-l border-[#76A7FF] px-0 xl:px-[20px] flex flex-col h-full">
