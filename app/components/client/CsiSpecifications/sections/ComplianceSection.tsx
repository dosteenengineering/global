    ...
    <section className="relative w-full select-none overflow-hidden">
      ...
      className="container py-12.5 md:py-140 3xl:py-150 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[1.5fr_1fr] 3xl:grid-cols-[967px_auto] gap-5 md:gap-80 items-center">
          <div>
            <Image src="/assets/images/csi-specifications/compliance.jpg" alt="UAE & Oman Compliance — Built Into Every Specification" width={800} height={600} className="w-full h-auto object-cover   " />
          </div>
          <div>
