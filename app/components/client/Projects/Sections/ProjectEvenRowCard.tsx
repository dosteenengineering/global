  ...
  return (
    <div className="group flex items-stretch w-full">
      ...
      <div className="flex flex-col justify-between pt-100 flex-1 min-w-0">
        <div>
          {/* Title */}
          <Link href={`/case-studies/${project.slug}`}><h2 className="text-secondary text-55 leading-[1.18181] tracking-[-0.02em] font-light mb-[15px]">
      ...
      {/* Right: image 855×855 */}
      <Link href={`/case-studies/${project.slug}`}><div className="relative w-[600px] h-[600px] 2xl:w-[740px] 2xl:h-[740px] 3xl:w-[855px] 3xl:h-[855px] shrink-0 overflow-hidden">
        <Image
