...
//           <div />
//           <h2 className="text-[36px] lg:text-90 leading-[1.111] uppercase font-helvetica max-w-[1129px]">
      ...
      {showLg ? (
        <div style={{ paddingLeft: leftInset }} className="py-140 3xl:py-200">
          <div className="grid grid-cols-[150px_1fr] 3xl:grid-cols-[215px_1fr] gap-x-15 3xl:gap-x-[70px] mb-10 xl:mb-14 3xl:mb-[70px] text-secondary">
            <div />
            <h2 className="section-font-size leading-[1.111] uppercase font-helvetica max-w-[1129px]">
              {industriesData.title}
            </h2>
          </div>

          <div className="grid grid-cols-[150px_1fr] 3xl:grid-cols-[215px_1fr] gap-x-15 3xl:gap-x-[70px] items-start">
            <div className="flex flex-col justify-start flex-shrink-0">
        ...
        <div className="py-140 container">
          <h2 className="section-font-size leading-[1.111] uppercase font-helvetica w-full mb-8 md:mb-10 text-secondary">
            {industriesData.title}
          </h2>
