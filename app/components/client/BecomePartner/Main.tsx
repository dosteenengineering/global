...
const Main = () => {
  ...
  return ( 
    <section className="min-h-screen 3xl:h-screen">
      <ContainerAnchor ref={containerRef} />
      <div className="grid xl:grid-cols-[1.2fr_2fr] 2xl:grid-cols-[1.5fr_2fr] 3xl:grid-cols-[841px_auto] h-full">
        <div style={{ paddingLeft: containerInset }} className="relative overflow-hidden h-full py-80 pr-5 md:pr-100 3xl:pr-[110px]">
          ...
          <div className="relative z-2">
            ...
            <div className="mt-140 mb-50">
              <h1 className="text-55 leading-[1.181818181818182] text-white font-light mb-20 -tracking-[0.02em]">Become a Dosteen Partner</h1>
              <p className="text-description text-white max-w-[40ch]">Join our approved supplier network and grow with engineering projects across the UAE & Oman.</p>
            </div>
            <div className="p-30 relative overflow-hidden">
              ...
              <p className="text-description text-white relative z-2">
                As part of our vendor verification process, Dosteen may request a factory visit to assess manufacturing standards, quality control practices, and overall production capabilities. This helps us ensure that all partners meet our quality and compliance criteria."
              </p>
            </div>
          </div>
        </div>
