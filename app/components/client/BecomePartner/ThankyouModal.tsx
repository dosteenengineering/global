  ...
  return (
    <div className="fixed inset-0 z-10  overflow-hidden">
      ...
      <div className="flex flex-col items-center text-center px-6 relative z-2 h-full mt-80">
        ...
        <h2 className="text-90 font-bold uppercase text-white leading-[1.111111111111111] text-secondary font-helvetica mb-20">
        Thank You!
      </h2>
        <p className="mt-4 text-paragraph text-30 leading-[1.333333333333333] max-w-[46.5ch] text-white font-light mb-50">
          Your application has been received. Our procurement team will review it within 5–7 working days and contact you.” 
      </p>
      <BorderButton text="GO TO HOME PAGE" href="/" iconColor="white" hoverBg="white" />
      </div>
    </div>
  );
};
