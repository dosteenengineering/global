...
const ThankYouModal = ({ isOpen,data }: { isOpen: boolean,data:any }) => {
  ...
  return (
    <div className="fixed inset-0 z-10 overflow-hidden">
      ...
      <div className="flex flex-col items-center text-center px-6 relative z-2 h-full mt-80">
        ...
        <p className="text-paragraph text-30 leading-[1.333333333333333] max-w-[47.5ch] text-white font-light mb-50" dangerouslySetInnerHTML={{__html:data.description}}>
          {/* Your application has been received. Our procurement <br/> team will review it within 5–7 working days and contact you.”  */}
      </p>
        <BorderButton text={data.buttonText} href={data.buttonLink} iconColor="white" hoverBg="white" className="2xl:px-[35px] 2xl:!py-[17.5px] [&_img]:!h-[18px] [&_img]:!w-[18px]" />
      </div>
    </div>
  );
};
