  ...
  return (
    <div className="relative">
      ...
      <div className="relative overflow-hidden py-12.5 md:py-60 px-[16px] md:px-0 md:mx-70">
        ...
        <SectionTitle text={`Systems &amp; Products`} className="text-55 text-secondary font-light tracking-[-0.02em] leading-[1.1818] mb-5 md:mb-40" />
        <div className="divide-y divide-[#c2c2c2]">
          {rows.map(({ key, value }, index) => (
            <motion.div variants={moveUp(index * 0.12)} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} key={key} className="grid md:grid-cols-[34%_66%] pb-30 pt-30 3xl:pb-[36px] 3xl:pt-[36px] first:pt-0 last:pb-0 gap-[5px] md:gap-0">
