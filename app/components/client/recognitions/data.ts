...
export const faqs = [
  {
    ...
    answer: "Our engineering team works primarily with Autodesk Revit for MEP coordination, Navisworks for clash detection, and AutoCAD for 2D documentation. We also support IFC-based workflows for interoperability with structural and architectural consultants.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer: "Yes. We routinely federate our MEP models into existing architectural and structural BIM environments. Our team will review your current model setup during the project kick-off and align with your BIM Execution Plan to ensure seamless coordination.",
  },
  {
    id: 4,
    question: "How does Dosteen handle clash detection?",
    answer: "We run regular Navisworks clash detection cycles throughout the design and coordination phases. Issues are tracked, assigned, and resolved collaboratively with all discipline leads. Our process follows ISO 19650 standards for information management and issue resolution.",
  },
];
