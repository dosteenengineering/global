...
const SystemForm = ({ editMode }: { editMode?: boolean }) => {
    ...
    const handleAddSystem = async (data: SystemFormProps) => {
        try {
            const response = await fetch(editMode ? `/api/admin/system?id=${id}` : `/api/admin/system`, {
...
fetchSystemData();
    ...
    return (
        <div className='flex flex-col gap-5'>
            <form className='flex flex-col gap-5 rounded-md' onSubmit={handleSubmit(handleAddSystem)}>
                ...
                <AdminItemContainer>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-5'>
                        ...
                        <div>
                            ...
                            <Textarea placeholder='First Description' {...register("firstSection.firstDescription", { required: "Description is required" })} />
                            {errors.firstSection?.firstDescription && <p className='text-red-500'>{errors.firstSection.firstDescription.message}</p>}
                        </div>

                        <div>
                            <Label className=''>Second Description</Label>
                            <Textarea placeholder='Second Description' {...register("firstSection.secondDescription", { required: "Description is required" })} />
                            {errors.firstSection?.secondDescription && <p className='text-red-500'>{errors.firstSection.secondDescription.message}</p>}
                        </div>

                        <div>
                            <Label className=''>Short Description</Label>
                            <Textarea placeholder='Short Description' {...register("firstSection.shortDescription")} />
                            {errors.firstSection?.shortDescription && <p className='text-red-500'>{errors.firstSection.shortDescription.message}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            <div className='border border-black/20 p-2 rounded-md flex flex-col gap-5 mt-0.5'>
                                    ...
                                    <div key={field.id} className='grid grid-cols-2 gap-2 relative border-b border-black/20 pb-2 last:border-b-0'>
                                        ...
                                        <div>
                                            ...
                                            <div className='flex flex-col gap-2'>
                                                ...
                                                <Input type='text' placeholder='Button Text' {...register(`secondSection.items.${index}.buttonText`)} />
                                            </div>
                                ...
                                <div className='flex justify-end'>
                                    <Button type='button' className="" addItem onClick={() => secondSectionAppend({ title: "",buttonText:"", description: "", image: "", imageAlt: "" })}>Add Item</Button>
                                </div>
                ...
                <AdminItemContainer>
                    ...
                    <div className='p-5 flex flex-col gap-2'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <div>
                                <Label className=''>Description</Label>
                                <Textarea placeholder='Description' {...register("thirdSection.description", { required: "Description is required" })} />
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <div className='border border-black/20 p-2 rounded-md flex flex-col gap-5'>
                                ...
                                <div className='flex justify-end'>
                                    <Button type='button' className="" addItem onClick={() => thirdSectionAppend({ title: "", link: "" })}>Add Item</Button>
                                </div>
                    ...
                    <div className='p-5 flex flex-col gap-2'>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <div className='border border-black/20 p-2 rounded-md flex flex-col gap-5'>
                                ...
                                <div className='flex justify-end'>
                                    <Button type='button' className="" addItem onClick={() => fourthSectionAppend({ title: "", logo: "", logoAlt: "", image: "", imageAlt: "" })}>Add Item</Button>
                                </div>
                ...
                <AdminItemContainer>
                    ...
                    <div className='p-5 rounded-md flex flex-col gap-2'>
                        ...
                        <div>
                            <Label className=''>Title</Label>
                            <Input type='text' placeholder='Title' {...register("fifthSection.title", { required: "Title is required" })} />
                                        ...
                                        <div className='grid grid-cols-2 gap-4'>
                                            ...
                                            <div className='flex flex-col gap-4'>
                                                ...
                                                <div>
                                                    ...
                                                    <Input
                                                        type='text'
                                                        {...register(`sixthSection.items.${index}.clientName`, {
                                                            required: "Client name is required"
                                                        })}
                                                    />
                                                    {errors.sixthSection?.items?.[index]?.clientName && (
                                                        <p className='text-red-500'>
                                                            {errors.sixthSection.items[index]?.clientName?.message}
                                                        </p>
                                                    )}
                                                </div>

                                                <div>
                                                    <Label className='font-bold'>Company / Designation</Label>
                                                    <Input
                                                        type='text'
                                                        {...register(`sixthSection.items.${index}.designation`, {
                                                            required: "Designation is required"
                                                        })}
                                                    />
                                                    {errors.sixthSection?.items?.[index]?.designation && (
                                                        <p className='text-red-500'>
                                                            {errors.sixthSection.items[index]?.designation?.message}
                                                        </p>
                                                    )}
                                                </div>
                                            ...
                                            <div className='flex flex-col gap-4'>
                                                ...
                                                <div>
                                                    ...
                                                    {errors.sixthSection?.items?.[index]?.description && (
                                                        <p className='text-red-500'>
                                                            {errors.sixthSection.items[index]?.description?.message}
                                                        </p>
                                                    )}
                                                </div>
                                    ...
                                    >
                                        ...
                                        <div className='flex flex-col gap-4'>
                                            ...
                                            <div>
                                                ...
                                                <Input
                                                    type='text'
                                                    {...register(`seventhSection.items.${index}.question`, {
                                                ...
                                                {errors.seventhSection?.items?.[index]?.question && (
                                                    <p className='text-red-500'>
                                                        {errors.seventhSection.items[index]?.question?.message}
                                                    </p>
                                                )}
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                {errors.seventhSection?.items?.[index]?.answer && (
                                                    <p className='text-red-500'>
                                                        {errors.seventhSection.items[index]?.answer?.message}
                                                    </p>
                                                )}
                                            </div>
