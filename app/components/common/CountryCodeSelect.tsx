      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={`absolute top-[calc(100%+8px)] h-[250px] left-0 backdrop-blur-md border rounded-2xl shadow-lg overflow-hidden z-50 ${isLight
          ...
          >
            {/* Search */}
            <div
              className={`px-3 py-2 border-b ${isLight ? "border-foreground-light/10" : "border-black/5"}`}
            >
              <input
                type="text"
                ...
                className={`w-full text-description bg-transparent outline-none p-0 ${isLight
              ...
              {filtered.map((c, i) => (
                <div key={`${c.code}-${i}`}>
                  ...
                  <button
                    ...
                    className={`w-full text-left px-5 py-3 text-description transition-colors duration-150 flex items-center gap-2 ${value === c.code
                        ? "text-primary-2 font-[avenirBook]"
                        : isLight
                  ...
                  >
                    ...
                    <span>{c.code} - </span>
                    <span
                      className={`text-[13px] ${isLight ? "text-foreground" : "text-foreground-light"}`}
                    >
                      {c.name}
                    </span>
                  </button>
